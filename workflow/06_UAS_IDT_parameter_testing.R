...
output_dir <- paste0(wd,"local_max")
...
for (i in seq_along(window_size)) {
  ...
  # Define the output GeoPackage name
  output_gpkg <- paste("local_vwf", window_size[i],window_size[r], sep="_")
...
# Define the output directory
output_dir <- paste0(wd,"exponetial")
...
# Define the output directory
output_dir <- paste0(wd,"quadratic")
...
for (i in seq_along(window_size)) {
  ...
  # Define the output GeoPackage name
  output_gpkg <- paste("local_smoothed", window_size[i], sep="_")
